...
function add_css2(target) {
  append_styles(target, "svelte-1dwiokw", ".task.svelte-1dwiokw.svelte-1dwiokw{background-color:var(--background-secondary-alt);border-radius:var(--radius-m);border:var(--border-width) solid var(--background-modifier-border);cursor:grab}.task.is-dragging.svelte-1dwiokw.svelte-1dwiokw{opacity:0.15}.task.svelte-1dwiokw .task-body.svelte-1dwiokw{padding:var(--size-4-2);display:grid;gap:var(--size-4-2);grid-template-columns:1fr auto}.task.svelte-1dwiokw .task-body p.svelte-1dwiokw{word-break:break-word;margin:0}.task.svelte-1dwiokw .task-body .task-content.svelte-1dwiokw{display:grid}.task.svelte-1dwiokw .task-body .task-content textarea.svelte-1dwiokw{cursor:text;background-color:var(--color-base-25);width:100%}.task.svelte-1dwiokw .task-body .task-content .content-preview.svelte-1dwiokw:focus-within{box-shadow:0 0 0 3px var(--background-modifier-border-focus)}.task.svelte-1dwiokw .task-footer.svelte-1dwiokw{border-top:var(--border-width) solid var(--background-modifier-border);padding:var(--size-4-2)}.task.svelte-1dwiokw .task-footer p.svelte-1dwiokw{margin:0;font-size:var(--font-ui-smaller)}.task-content *{word-break:break-word;margin:0}");
}
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "content-preview svelte-1dwiokw");
      attr(div, "tabindex", "0");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(textarea, "class", "svelte-1dwiokw");
      toggle_class(
        textarea,
        "editing",
        /*isEditing*/
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      p = element("p");
      t = text(t_value);
      attr(p, "class", "svelte-1dwiokw");
      attr(div, "class", "task-footer svelte-1dwiokw");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, p);
...
function create_fragment3(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "task-content svelte-1dwiokw");
      attr(div1, "class", "task-body svelte-1dwiokw");
      attr(div2, "class", "task svelte-1dwiokw");
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*task*/
    1) {
      $: $$invalidate(7, mdContent = mdConverted.makeHtml(task.content + (task.blockLink ? ` ^${task.blockLink}` : "")));
    }
...
function create_if_block2(ctx) {
  ...
  let if_block0 = (
    /*column*/
    ctx[0] === "done" && create_if_block_2(ctx)
  );
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*sortedTasks, taskActions, columnTagTableStore, showFilepath*/
      568) {
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      512) taskcomponent_changes.task = /*task*/
      ctx2[20];
      if (dirty & /*taskActions*/
...
function instance4($$self, $$props, $$invalidate) {
  ...
  let canDrop;
  let $isDraggingStore;
  let $columnTagTableStore, $$unsubscribe_columnTagTableStore = noop, $$subscribe_columnTagTableStore = () => ($$unsubscribe_columnTagTableStore(), $$unsubscribe_columnTagTableStore = subscribe(columnTagTableStore, ($$value) => $$invalidate(16, $columnTagTableStore = $$value)), columnTagTableStore);
  component_subscribe($$self, isDraggingStore, ($$value) => $$invalidate(15, $isDraggingStore = $$value));
  $$self.$$.on_destroy.push(() => $$unsubscribe_columnTagTableStore());
  let { column } = $$props;
  ...
  function handleDragOver(e) {
    ...
    $$invalidate(8, isDraggedOver = true);
    if (e.dataTransfer) {
      e.dataTransfer.dropEffect = "move";
    }
  }
  function handleDragLeave(e) {
    $$invalidate(8, isDraggedOver = false);
  }
  ...
  $$self.$$.update = () => {
    ...
    65537) {
      $: $$invalidate(10, columnTitle = getColumnTitle(column, $columnTagTableStore));
    }
    if ($$self.$$.dirty & /*tasks*/
    4) {
      $: $$invalidate(9, sortedTasks = tasks.sort((a, b) => {
        if (a.path === b.path) {
    ...
    32768) {
      $: $$invalidate(7, draggingData = $isDraggingStore);
    }
...
function create_each_block3(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      320) column_1_changes.tasks = /*tasksByColumn*/
      (_a2 = ctx2[8][
        /*column*/
        ctx2[20]
      ]) != null ? _a2 : [];
      ...
      ctx2[2];
      if (dirty & /*showFilepath*/
      128) column_1_changes.showFilepath = /*showFilepath*/
      ctx2[7];
...
function create_fragment11(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*tags*/
      512) selecttag_changes.tags = [.../*tags*/
      ctx2[9]];
      ...
      256) column0_changes.tasks = /*tasksByColumn*/
      ctx2[8]["uncategorised"];
      if (dirty & /*taskActions*/
      ...
      ctx2[2];
      if (dirty & /*showFilepath*/
      128) column0_changes.showFilepath = /*showFilepath*/
      ctx2[7];
      column0.$set(column0_changes);
      if (dirty & /*columns, tasksByColumn, taskActions, columnTagTableStore, showFilepath*/
      454) {
        each_value = ensure_array_like(
          /*columns*/
          ctx2[6]
      ...
      if (dirty & /*tasksByColumn*/
      256) column1_changes.tasks = /*tasksByColumn*/
      (_a2 = ctx2[8]["done"]) != null ? _a2 : [];
      if (dirty & /*taskActions*/
      ...
      ctx2[2];
      if (dirty & /*showFilepath*/
      128) column1_changes.showFilepath = /*showFilepath*/
      ctx2[7];
...
function instance8($$self, $$props, $$invalidate) {
  ...
  let tasksByColumn;
  let showFilepath;
  let $settingsStore, $$unsubscribe_settingsStore = noop, $$subscribe_settingsStore = () => ($$unsubscribe_settingsStore(), $$unsubscribe_settingsStore = subscribe(settingsStore, ($$value) => $$invalidate(15, $settingsStore = $$value)), settingsStore);
  let $tasksStore, $$unsubscribe_tasksStore = noop, $$subscribe_tasksStore = () => ($$unsubscribe_tasksStore(), $$unsubscribe_tasksStore = subscribe(tasksStore, ($$value) => $$invalidate(16, $tasksStore = $$value)), tasksStore);
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("taskActions" in $$props2) $$invalidate(1, taskActions = $$props2.taskActions);
    if ("openSettings" in $$props2) $$invalidate(11, openSettings = $$props2.openSettings);
  ...
  $$self.$$.update = () => {
    ...
    65536) {
      $: $$invalidate(9, tags = $tasksStore.reduce(
        (acc, curr) => {
    ...
    16) {
      $: $$invalidate(14, selectedTagsSet = new Set(selectedTags));
    }
    ...
    65568) {
      $: $$invalidate(13, filteredByText = filterText ? $tasksStore.filter((task) => task.content.toLowerCase().includes(filterText.toLowerCase())) : $tasksStore);
    }
    if ($$self.$$.dirty & /*selectedTagsSet, filteredByText*/
    24576) {
      $: $$invalidate(12, filteredByTag = selectedTagsSet.size ? filteredByText.filter((task) => {
    ...
    4096) {
      $: $$invalidate(8, tasksByColumn = groupByColumnTag(filteredByTag));
    }
    if ($$self.$$.dirty & /*$settingsStore*/
    32768) {
      $: $$invalidate(7, showFilepath = (_a = $settingsStore.showFilepath) != null ? _a : true);
    }
  };
  return [
    tasksStore,
...
async function updateMapsFromFile({
  ...
  try {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      if (isTaskString(row)) {
        const task = new Task2(row, fileHandle, i, columnTagTable);
...
// src/ui/tasks/store.ts
function createTasksStore(vault, workspace, registerEvent, columnTagTableStore, getFilenameFilter) {
